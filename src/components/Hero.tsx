export default function Hero() {
    return (
        <section
            id="hero"
            className="relative min-h-screen flex items-start md:items-center justify-center overflow-hidden pt-20 pb-8 md:pt-0 md:pb-0"
        >
            ...
            <div className="relative z-10 container-custom text-center text-white px-4">
                <div className="max-w-4xl mx-auto animate-fade-in-up">
                    {/* Main Heading */}
                    <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4 md:mb-6">
                        Temukan Petualangan
                        <br />
                    ...
                    {/* Subheading */}
                    <p className="text-base md:text-xl text-white/90 max-w-2xl mx-auto mb-6 md:mb-10 leading-relaxed">
                    ...
                    {/* Trust Badges */}
                    <div className="flex flex-wrap justify-center gap-4 md:gap-10 mt-6 md:mt-10 text-white/80">
